...
1. l’aggiunta di un elemento in una rubrica piena comporti, prima, il raddoppio della capacit`a della
rubrica e, successivamente, l’effettiva aggiunta dell’elemento (anzich ́e il fallimento dell’opera-
zione).
2. i contatti vengano mantenuti in rubrica in ordine lessicografico crescente rispetto al campo
nome del contatto;
3. tutti i metodi che necessitano di cercare un contatto tramite il nome sfruttino il fatto che i
contatti sono mantenuti ordinati, per ridurre lo sforzo computazionale.
